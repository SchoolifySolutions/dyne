...
export default function Bootcamp() {
  ...
  const [where, setWhere] = useState("linkedin");
  ...
  const formSubmission = async (e) => {
    ...
    try {
      ...
      setExperience("");
      setSchool("");
      setCountry("Afghanistan"); // Default country
      setWhere("linkedin");

      if (response.data.message === "Submission successful") {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-white font-normal text-[4vh] md:text-[6vh] text-center">
          Learn{" "}
          <span className="text-blue-500 font-normal text-[4vh] md:text-[6vh] text-center">
        ...
        <div className="md:w-[70vw] w-[90vw] mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between mt-10">
            ...
            <div className="md:w-1/3 w-[90vw] md:mx-4 mx-0  h-fit mt-10 md:mt-0">
              ...
              ></img>
              <h2 className="text-neutral-100 font-normal text-2xl mt-7 mb-10 md:mb-0">
